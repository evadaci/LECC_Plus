...
while stop != True:
    ...
    if (duration > 10) and (duration < 10.999):
        ...
        window.bgpic('question1begcpp.png')
        answer1=turtle.textinput("Question 1","CPP SYNTAX")
    ...
    if (duration > 20) and (duration < 20.999):
        tr1.hideturtle()
        ourturtle.hideturtle()
        window.bgpic('question2begcpp.png')
        answer2=turtle.textinput("Question 2","CPP VARIABLES")
    ...
    if (duration > 30) and (duration < 30.999):
        tr1.hideturtle()
        ourturtle.hideturtle()
        window.bgpic('question3begcpp.png')
        answer3=turtle.textinput("Question 3","CPP STRINGS")

        if answer3=='str.length()':
            tr1.showturtle()
            ourturtle.showturtle()
            window.bgpic('LOGO_.png')
            scorelec += 1
    ...
    if (duration > 40) and (duration < 40.999):
        tr1.hideturtle()
        ourturtle.hideturtle()
        window.bgpic('question4begcpp.png')
        answer4=turtle.textinput("Question 4","CPP OPERATORS")
    ...
    if (duration > 50) and (duration < 50.999):
        tr1.hideturtle()
        ourturtle.hideturtle()
        window.bgpic('question5begcpp.png')
        answer5=turtle.textinput("Question 5","CPP MATH")

        if answer5=='1)math.h 2)pow':
            tr1.showturtle()
            ourturtle.showturtle()
            window.bgpic('LOGO_.png')
            scorelec += 1
