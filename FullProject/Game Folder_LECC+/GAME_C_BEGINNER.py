...
while stop != True:
    ...
    if (duration > 10) and (duration < 10.999):
        ...
        window.bgpic('question1begc.png')
        answer1=turtle.textinput("Question 1","READ THE QUESTION IN THE PHOTO.")

        if answer1=='printf("Hello, World!");':
            tr1.showturtle()
    ...
    if (duration > 20) and (duration < 20.999):
        tr1.hideturtle()
        ourturtle.hideturtle()
        window.bgpic('question2begc.png')
        answer2=turtle.textinput("Question 2","READ THE QUESTION IN THE PHOTO.")

        if answer2=='sum = a + b + c':
            tr1.showturtle()
            ourturtle.showturtle()
            window.bgpic('LOGO_.png')
            scorelec += 1
    ...
    if (duration > 30) and (duration < 30.999):
        tr1.hideturtle()
        ourturtle.hideturtle()
        window.bgpic('question3begc.png')
        answer3=turtle.textinput("Question 3","READ THE QUESTION IN THE PHOTO.")

        if answer3=='65480, 65496':
            tr1.showturtle()
            ourturtle.showturtle()
            window.bgpic('LOGO_.png')
            scorelec += 1
    ...
    if (duration > 40) and (duration < 40.999):
        tr1.hideturtle()
        ourturtle.hideturtle()
        window.bgpic('question4begc.png')
        answer4=turtle.textinput("Question 4","READ THE QUESTION IN THE PHOTO.")
    ...
    if (duration > 50) and (duration < 50.999):
        tr1.hideturtle()
        ourturtle.hideturtle()
        window.bgpic('question5begc.png')
        answer5=turtle.textinput("Question 5","READ THE QUESTION IN THE PHOTO.")
