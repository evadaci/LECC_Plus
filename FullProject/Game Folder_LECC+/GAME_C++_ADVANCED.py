...
while stop != True:
    ...
    if (duration > 10) and (duration < 10.999):
        ...
        window.bgpic('question1advcpp.png')
        answer1=turtle.textinput("Question 1","CPP BOOLEANS")

        if answer1=='x>y' or answer1=='y<x' or answer1=='X>Y' or answer1=='Y<X':
            tr1.showturtle()
    ...
    if (duration > 20) and (duration < 20.999):
        tr1.hideturtle()
        ourturtle.hideturtle()
        window.bgpic('question2advcpp.png')
        answer2=turtle.textinput("Question 2","CPP CONDITIONS AND IF STATEMENTS")

        if answer2=='Good evening':
            tr1.showturtle()
            ourturtle.showturtle()
            window.bgpic('LOGO_.png')
            scorelec += 1
    ...
    if (duration > 30) and (duration < 30.999):
        tr1.hideturtle()
        ourturtle.hideturtle()
        window.bgpic('question3advcpp.png')
        answer3=turtle.textinput("Question 3","CPP SWITCH STATEMENTS")

        if answer3=='WRONG INPUT':
            tr1.showturtle()
            ourturtle.showturtle()
            window.bgpic('LOGO_.png')
            scorelec += 1
    ...
    if (duration > 40) and (duration < 40.999):
        tr1.hideturtle()
        ourturtle.hideturtle()
        window.bgpic('question4advcpp.png')
        answer4=turtle.textinput("Question 4","CPP WHILE LOOP")

        if answer4=='1)do; 2)while; 3)7':
            tr1.showturtle()
            ourturtle.showturtle()
            window.bgpic('LOGO_.png')
            scorelec += 1
    ...
    if (duration > 50) and (duration < 50.999):
        tr1.hideturtle()
        ourturtle.hideturtle()
        window.bgpic('question5advcpp.png')
        answer5=turtle.textinput("Question 5","CPP FOR LOOP")

        if answer5=='1)for; 2)i++; 3)"CPP"':
            tr1.showturtle()
            ourturtle.showturtle()
            window.bgpic('LOGO_.png')
            scorelec += 1
